...
<div class="scrolly-wrapper">
    <Scrolly bind:progress={ scrollyProgress }>
        ...
        <svelte:fragment slot="viz">
            ...
            <h3>{sorted_projects[activeProjectIdx].title}</h3> 
            <img src={sorted_projects[activeProjectIdx].image} alt="image of my project titled {sorted_projects[activeProjectIdx].title}">
            </div>
